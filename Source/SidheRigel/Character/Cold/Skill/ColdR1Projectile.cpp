...
// Sets default values
AColdR1Projectile::AColdR1Projectile()
{
	...
	if (!ProjectileMesh)
	{
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh>Mesh(TEXT("/Game/Heros/Cold/Skill/SM_ColdR1Projectile"));
		if (Mesh.Succeeded())
		{
...
void AColdR1Projectile::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AColdR1Projectile::Tick(float DeltaTime)
{
