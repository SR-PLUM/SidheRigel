...
FairyWingQSkill::FairyWingQSkill()
{
...
void FairyWingQSkill::SetSkillProperty(ASidheRigelCharacter* Character, E_SkillState SkillState)
{
	skillDelay = 1.f;
	skillCooldown = 0;
...
void FairyWingQSkill::OnUse(FHitResult Hit)
{
